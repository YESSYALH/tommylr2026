...
export default function DashboardHeader() {
  ...
  return (
    <header className="h-20 border-b border-slate-200 bg-white/60 backdrop-blur-md flex items-center justify-between px-8 z-20 shadow-sm">
      <div className="flex items-center gap-4 bg-slate-100 rounded-xl px-4 py-2 border border-slate-200 w-96 transition-all focus-within:bg-white focus-within:border-emerald-300 focus-within:shadow-[0_0_0_4px_rgba(52,211,153,0.1)]">
