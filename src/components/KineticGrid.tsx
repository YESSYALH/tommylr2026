...
const COMPONENT_DEFAULTS = {
    ...
    dotColor: "rgba(13, 30, 70, 0.5)", // Dark Blue dots
...
export default function KineticGrid(props: KineticGridProps) {
    ...
    useEffect(() => {
        ...
        // Attach to window so it tracks correctly even if the canvas is behind other elements
    ...
    return (
        <div
            ...
            style={{
                ...
                background,
                zIndex: 9999,
                pointerEvents: "none", // Prevent it from blocking clicks on the rest of the site
                ...(finalProps.style || {}),
            }}
        >
            <canvas
